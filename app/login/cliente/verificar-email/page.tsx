...
function VerifyEmailContent() {
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      setCooldown(45); // Cooldown de 45 segundos
    } catch (err: unknown) {
  ...
  return (
    <div style={{ backgroundColor: 'var(--bg-card)', borderRadius: 20, padding: 32, boxShadow: '0 32px 64px rgba(0,0,0,0.4)', border: '1px solid var(--border)', width: '100%', maxWidth: 440 }}>
      ...
      <div style={{ marginTop: 24, textAlign: 'center' }}>
        <button onClick={() => router.push('/login/cliente')} style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: 12, color: 'var(--text-secondary)', padding: 0 }}>
